...
/*      06-12-02    saa - Make OdlGetFileSpec return "fspec" when         */
/*                        "orig_fspec" does not contain any "/" (instead  */
/*                        of "orig_fspec" which it currently returns)     */
/*      03-06-03    saa - OdlValidElement overwrote out of bounds memory  */
/*                        when a value with inline units was specified    */
/*                        with no spaces inbetween, such as:              */
...
/*                                                                      */
/*      03-31-94    Original code                                       */
/* SAA  06-12-02    When orig_fspec has no path component in it, the    */
/*                  fspec erroneously contains orig_fspec instead of    */
/*                  fspec.                                              */
/*                                                                      */
/*----------------------------------------------------------------------*/
/*                                                                      */
    ...
    else
    {
        ...
        while (! end_found && fgets(intext, TB_MAXLINE, l_ptr))
        {
            if (strchr(intext, '\n') == NULL) {
                 ...
                 **/
					 OdlPrintMessage(NULL,stderr,(line_number+1),
						"Line too long...skipping rest of file\n");
                break;
            }
            ++line_number;
